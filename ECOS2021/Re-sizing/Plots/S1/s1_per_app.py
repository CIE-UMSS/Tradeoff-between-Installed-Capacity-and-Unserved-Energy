...
s1=pd.read_csv('s1_hourly.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
...
#unimos todo el data
BSAhourly=pd.concat([LCOE_BSA, h_BSA,indoor_bulb,outdoor_bulb,radio,tv,phone_charger,water_heater,mixer,s1], axis=1, sort=False)
...
#unimos todo el data
BSAhourly_1=pd.concat([NPC_BSA, h_BSA,indoor_bulb,outdoor_bulb,radio,tv,phone_charger,water_heater,mixer,s1], axis=1, sort=False)
...
ax.legend()
ax.legend(handles = [l0,l1,l2,l3,l4,l5,l6,l7,l8,l9] , labels=['Demand', 'LL', 'indoor bulb', 'outdoor bulb', 'radio', 'tv', 'water heater', 'mixer','phone charger','Fridge+Freezer*'],loc='upper right',bbox_to_anchor=(1.55, 0.98),fancybox=False, shadow=False,ncol=1)
plt.savefig('per_app_comp_s1.png',dpi=600,bbox_inches="tight")
plt.show()
