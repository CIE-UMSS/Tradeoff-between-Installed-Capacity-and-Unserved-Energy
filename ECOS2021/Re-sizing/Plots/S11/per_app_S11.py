...
#axs[0].set_ylim([0, 50])
#axs[1].set_ylim([0, 50])
ax.legend(handles = [l0,l1,l2,l3,l4,l5,l8,l6] , labels=['Demand', 'LL', 'indoor bulb', 'outdoor bulb', 'radio', 'tv', 'phone charger','water pump'],loc='upper right',bbox_to_anchor=(1.55, 0.98),fancybox=False, shadow=False, ncol=1)

plt.savefig('per_app_comp_S11.png',dpi=600,bbox_inches="tight")
plt.show()
