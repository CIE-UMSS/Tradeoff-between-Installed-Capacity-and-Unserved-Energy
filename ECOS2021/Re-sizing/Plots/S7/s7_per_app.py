...
ax.legend()
ax.legend(handles = [l0,l1,l2,l3,l4,l5,l6,l7,l8,l9] , labels=['Demand', 'LL', 'indoor bulb', 'outdoor bulb', 'radio', 'tv', 'water heater', 'mixer','phone charger','grinder'],loc='upper right',bbox_to_anchor=(1.55, 0.98),fancybox=False, shadow=False, ncol=1)
plt.savefig('per_app_comp_s7.png',dpi=600,bbox_inches="tight")
plt.show()
