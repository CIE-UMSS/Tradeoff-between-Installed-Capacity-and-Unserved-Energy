...
# -*- coding: utf-8 -*-
"""
Created on Tue Jun  1 22:52:38 2021
...
residuals = ydata- func8(xdata, *popt)
...
o= plt.plot(xp, func8(xp,*popt), '--', label='fit', color='green')
