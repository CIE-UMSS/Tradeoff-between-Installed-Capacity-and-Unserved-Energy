...
# -*- coding: utf-8 -*-
"""
Created on Tue Jun  1 21:04:05 2021
...
def funcbsb(x, a, b, c,d,e):
    return (a*x-b)/(c*x**e+d)
xdata = df['LLP']
ydata=df['NPC']
plt.figure(figsize=(10,10))
plt.plot(xdata, ydata, 'b-', label='data')
popt, pcov = curve_fit(funcbsb, xdata, ydata)

residuals = ydata- funcbsb(xdata, *popt)
...
o= plt.plot(xp, funcbsb(xp,*popt), '--', label='fit', color='green')
