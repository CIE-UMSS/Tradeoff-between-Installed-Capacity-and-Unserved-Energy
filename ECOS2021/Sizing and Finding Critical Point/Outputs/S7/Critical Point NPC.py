...
# -*- coding: utf-8 -*-
"""
Created on Tue Jun  1 21:51:15 2021
...
import pandas as pd
BSA=pd.read_csv('S7.csv', sep=',', decimal='.', encoding='latin1')
...
popt, pcov = curve_fit(func7, xdata, ydata)
popt

residuals = ydata- func7(xdata, *popt)
...
S7f=popt
S7r2=r_squared
S7x=rt['x1'].iloc[rt['d'].idxmax()]
S7y=rt['y1'].iloc[rt['d'].idxmax()]

plt.figure(figsize=(10,6.7))
xp = np.linspace(0,1, 100)
_ = plt.plot(x_1, y_1, '.',label='data', color='blue')
o= plt.plot(xp, func7(xp,*popt), '--', label='fit', color='green')
...
#plt.plot(x_1, y_1, '-')
plt.plot(S7x,S7y, marker='o', markersize=5, color="red", label='critical point')
#escala real
