...
# -*- coding: utf-8 -*-
"""
Created on Tue Jun  1 21:20:27 2021
...
S2f=popt
S2r2=r_squared
S2x=rt['x1'].iloc[rt['d'].idxmax()]
S2y=rt['y1'].iloc[rt['d'].idxmax()]
...
o= plt.plot(xp, func2(xp,*popt), '--', label='fit', color='green')
...
#plt.plot(x_1, y_1, '-')
plt.plot(S2x,S2y, marker='o', markersize=5, color="red", label='critical point')
#escala real
