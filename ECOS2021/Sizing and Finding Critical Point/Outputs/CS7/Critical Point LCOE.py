...
# -*- coding: utf-8 -*-
"""
Created on Wed Jun  2 08:21:24 2021
...
import pandas as pd
BSA=pd.read_csv('CS7.csv', sep=',', decimal='.', encoding='latin1')
...
CS7f=popt
CS7r2=r_squared
CS7x=rt['x1'].iloc[rt['d'].idxmax()]
CS7y=rt['y1'].iloc[rt['d'].idxmax()]
...
#plt.plot(x_1, y_1, '-')
plt.plot(CS7x,CS7y, marker='o', markersize=5, color="red", label='critical point')
#escala real
...
print('R2=',CS7r2)
print('parameters=',CS7f)
print('critical point=',CS7x)
