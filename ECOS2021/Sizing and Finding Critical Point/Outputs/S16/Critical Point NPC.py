...
# -*- coding: utf-8 -*-
"""
Created on Wed Jun  2 00:22:27 2021
...
xdata = df['LLP']
ydata=df['NPC']
popt, pcov = curve_fit(func16, xdata, ydata)

residuals = ydata- func16(xdata, *popt)
...
o= plt.plot(xp, func16(xp,*popt), '--', label='fit', color='green')
