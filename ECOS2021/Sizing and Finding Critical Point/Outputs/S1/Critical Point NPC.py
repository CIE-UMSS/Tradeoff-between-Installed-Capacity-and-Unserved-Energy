...
# -*- coding: utf-8 -*-
"""
Created on Tue Jun  1 21:12:20 2021
...
def func1(x, a, b, c,d,e,f,g,h):
    return (a*x**f-b)/(c*x**e+d+x**f+x**g+x**h)
xdata = df['LLP']
ydata=df['NPC']
...
#(a*x**f-b)/(c*x**e+d+x**f+x**g+x**h)
f=(popt[0]*x**popt[5]-popt[1])/(popt[2]*x**popt[4]+popt[3]+x**popt[5]+x**popt[6]+x**popt[7])
#eq1=Eq(l1-j)
eq3=Eq(f-j)
