...
# -*- coding: utf-8 -*-
"""
Created on Tue Jun  1 17:10:34 2021

@author: alejandrosoto
"""

import pandas as pd
Jan=pd.read_csv('Jan_S16_o.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Feb=pd.read_csv('Feb_S16_o.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Jun=pd.read_csv('Jun_S16_o.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Aug=pd.read_csv('Aug_S16_o.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Dec=pd.read_csv('Dec_S16_o.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
...
Dec['Unnamed: 0'] = Dec['Unnamed: 0'].astype(float)

Feb_3=pd.read_csv('Feb_S16_o1.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Feb_3['0'] = Feb_3['0'].astype(float)
Feb_3['Unnamed: 0'] = Feb_3['Unnamed: 0'].astype(float)

Jan_2=pd.read_csv('Jan_S16_t1.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Jan_2['0'] = Jan_2['0'].astype(float)
Jan_2['Unnamed: 0'] = Jan_2['Unnamed: 0'].astype(float)

Jan_1=pd.read_csv('Jan_S16_t.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Feb_1=pd.read_csv('Feb_S16_t.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Mar_1=pd.read_csv('Mar_S16_t.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Apr_1=pd.read_csv('Apr_S16_t.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
May_1=pd.read_csv('May_S16_t.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Jun_1=pd.read_csv('Jun_S16_t.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Jul_1=pd.read_csv('Jul_S16_t.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Aug_1=pd.read_csv('Aug_S16_t.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Sep_1=pd.read_csv('Sep_S16_t.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Oct_1=pd.read_csv('Oct_S16_t.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Nov_1=pd.read_csv('Nov_S16_t.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
#Dec_1=pd.read_csv('Dec_S16_t.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
...
Feb_3['time_series']=np.arange(0,len(Feb_3),1)
Feb_3['time_series']=Feb_3['time_series']/60
...
import numpy as np
Jan_1['time_series']=np.arange(0,len(Jan_1),1)
...
Jan_S4=pd.read_csv('Jan_S16_B.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Feb_S4=pd.read_csv('Feb_S16_B.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Mar_S4=pd.read_csv('Mar_S16_B.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Apr_S4=pd.read_csv('Apr_S16_B.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
May_S4=pd.read_csv('May_S16_B.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Jun_S4=pd.read_csv('Jun_S16_B.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Jul_S4=pd.read_csv('Jul_S16_B.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Aug_S4=pd.read_csv('Aug_S16_B.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Sep_S4=pd.read_csv('Sep_S16_B.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Oct_S4=pd.read_csv('Oct_S16_B.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Nov_S4=pd.read_csv('Nov_S16_B.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Dec_S4=pd.read_csv('Dec_S16_B.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
...
l3,=axs[0, 0].plot(Jan_2['time_series'], Jan_2['0'],color='#C7fdb5',linewidth=1)
...
l4,=axs[0, 1].plot(Feb['time_series'], Feb['0'],color='#cafffb',linewidth=1)
axs[0, 1].plot(Feb_1['time_series'], Feb_1['0'],color='lightsteelblue',linewidth=1)
axs[0, 1].plot(Feb_3['time_series'], Feb_3['0'],color='pink',linewidth=1)
...
ax.legend(handles = [l0,l1,l2,l3,l4] , labels=['atypical', 'occasional', 'average', 'occasional 1', 'occasional 2'],bbox_to_anchor=(1.4,4),fancybox=False,loc='upper right', shadow=False)
...
Feb_2_sort=Feb_3
Feb_3_sort=Feb_3.sort_values(['0'],ascending=False)
Feb_3_sort=Feb_3_sort.reset_index()
del Feb_3_sort['index']
del Feb_3_sort['time_series']
Feb_3_sort['index_1']=Feb_3_sort.index[()]
for i in range (0,len(Feb_3_sort),1):
     Feb_3_sort.loc[Feb_3_sort['index_1']>=0, 'index_2'] = Feb_3_sort['index_1']/(len(Feb_3_sort)-1)
...
l3,=axs[0, 0].plot(Jan_2_sort['index_2'], Jan_2_sort['0'],color='#C7fdb5',linewidth=1)
...
axs[0, 1].plot(Feb_sort['index_2'], Feb_sort['0'],color='#cafffb',linewidth=1)
axs[0, 1].plot(Feb_1_sort['index_2'], Feb_1_sort['0'],color='lightsteelblue',linewidth=1)
l4,=axs[0, 1].plot(Feb_3_sort['index_2'], Feb_3_sort['0'],color='pink',linewidth=1)
...
#plt.savefig('profiles_temp_raq_2018.png', dpi=200,bbox_inches="tight")
ax.legend(handles = [l0,l1,l2,l3,l4] , labels=['atypical', 'occasional', 'average', 'occasional 1', 'occasional 2'],bbox_to_anchor=(1.5,5.5),fancybox=False,loc='upper right', shadow=False)
