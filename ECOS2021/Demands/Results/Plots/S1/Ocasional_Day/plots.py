...
# -*- coding: utf-8 -*-
"""
Created on Tue Jun  1 12:19:03 2021
...
import pandas as pd
import numpy as np
Jan=pd.read_csv('Jan_S1_o.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Feb=pd.read_csv('Feb_S1_o.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Mar=pd.read_csv('Mar_S1_o.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Apr=pd.read_csv('Apr_S1_o.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
May=pd.read_csv('May_S1_o.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Jun=pd.read_csv('Jun_S1_o.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Jul=pd.read_csv('Jul_S1_o.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Aug=pd.read_csv('Aug_S1_o.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Sep=pd.read_csv('Sep_S1_o.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Oct=pd.read_csv('Oct_S1_o.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Nov=pd.read_csv('Nov_S1_o.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Dec=pd.read_csv('Dec_S1_o.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
...
Jan_1=pd.read_csv('Jan_S1_t.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Feb_1=pd.read_csv('Feb_S1_t.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Mar_1=pd.read_csv('Mar_S1_t.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Apr_1=pd.read_csv('Apr_S1_t.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
May_1=pd.read_csv('May_S1_t.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Jun_1=pd.read_csv('Jun_S1_t.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Jul_1=pd.read_csv('Jul_S1_t.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Aug_1=pd.read_csv('Aug_S1_t.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Sep_1=pd.read_csv('Sep_S1_t.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Oct_1=pd.read_csv('Oct_S1_t.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Nov_1=pd.read_csv('Nov_S1_t.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Dec_1=pd.read_csv('Dec_S1_t.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
...
Jan_S1_A=pd.read_csv('Jan_S1_A.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Feb_S1_A=pd.read_csv('Feb_S1_A.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Mar_S1_A=pd.read_csv('Mar_S1_A.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Apr_S1_A=pd.read_csv('Apr_S1_A.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
May_S1_A=pd.read_csv('May_S1_A.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Jun_S1_A=pd.read_csv('Jun_S1_A.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Jul_S1_A=pd.read_csv('Jul_S1_A.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Aug_S1_A=pd.read_csv('Aug_S1_A.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Sep_S1_A=pd.read_csv('Sep_S1_A.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Oct_S1_A=pd.read_csv('Oct_S1_A.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Nov_S1_A=pd.read_csv('Nov_S1_A.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Dec_S1_A=pd.read_csv('Dec_S1_A.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Jan_S1_A['0'] = Jan_S1_A['0'].astype(float)
Jan_S1_A['Unnamed: 0'] = Jan_S1_A['Unnamed: 0'].astype(float)
Feb_S1_A['0'] = Feb_S1_A['0'].astype(float)
Feb_S1_A['Unnamed: 0'] = Feb_S1_A['Unnamed: 0'].astype(float)
Mar_S1_A['0'] = Mar_S1_A['0'].astype(float)
Mar_S1_A['Unnamed: 0'] = Mar_S1_A['Unnamed: 0'].astype(float)
Apr_S1_A['0'] = Apr_S1_A['0'].astype(float)
Apr_S1_A['Unnamed: 0'] = Apr_S1_A['Unnamed: 0'].astype(float)
May_S1_A['0'] = May_S1_A['0'].astype(float)
May_S1_A['Unnamed: 0'] = May_S1_A['Unnamed: 0'].astype(float)
Jun_S1_A['0'] = Jun_S1_A['0'].astype(float)
Jun_S1_A['Unnamed: 0'] = Jun_S1_A['Unnamed: 0'].astype(float)
Jul_S1_A['0'] = Jul_S1_A['0'].astype(float)
Jul_S1_A['Unnamed: 0'] = Jul_S1_A['Unnamed: 0'].astype(float)
Aug_S1_A['0'] = Aug_S1_A['0'].astype(float)
Aug_S1_A['Unnamed: 0'] = Aug_S1_A['Unnamed: 0'].astype(float)
Sep_S1_A['0'] = Sep_S1_A['0'].astype(float)
Sep_S1_A['Unnamed: 0'] = Sep_S1_A['Unnamed: 0'].astype(float)
Oct_S1_A['0'] = Oct_S1_A['0'].astype(float)
Oct_S1_A['Unnamed: 0'] = Oct_S1_A['Unnamed: 0'].astype(float)
Nov_S1_A['0'] = Nov_S1_A['0'].astype(float)
Nov_S1_A['Unnamed: 0'] = Nov_S1_A['Unnamed: 0'].astype(float) 
Dec_S1_A['0'] = Dec_S1_A['0'].astype(float)
Dec_S1_A['Unnamed: 0'] = Dec_S1_A['Unnamed: 0'].astype(float)


#point by point average
Jan_S1_A['time']=pd.date_range(start='1/1/2018', end='2/1/2018', freq='1min', closed='left')
Jan_S1_A['time'] = Jan_S1_A['time'].astype('str') 
Jan_S1_A[['local_date','local_time']] = Jan_S1_A.time.str.split(" ",expand=True,)
Jan_S1_A_mean=Jan_S1_A.groupby(Jan_S1_A.local_time).mean()
del Jan_S1_A_mean['Unnamed: 0']
Jan_S1_A_mean['time_series']=np.arange(0,len(Jan_S1_A_mean),1)
Jan_S1_A_mean=Jan_S1_A_mean.rename(columns={'0':'power'})
Jan_S1_A_mean['power']=Jan_S1_A_mean['power']
Jan_S1_A_mean['time_series']=Jan_S1_A_mean['time_series']/60

Feb_S1_A['time']=pd.date_range(start='2/1/2018', end='3/1/2018', freq='1min', closed='left')
Feb_S1_A['time'] = Feb_S1_A['time'].astype('str') 
Feb_S1_A[['local_date','local_time']] = Feb_S1_A.time.str.split(" ",expand=True,)
Feb_S1_A_mean=Feb_S1_A.groupby(Feb_S1_A.local_time).mean()
del Feb_S1_A_mean['Unnamed: 0']
Feb_S1_A_mean['time_series']=np.arange(0,len(Feb_S1_A_mean),1)
Feb_S1_A_mean=Feb_S1_A_mean.rename(columns={'0':'power'})
Feb_S1_A_mean['power']=Feb_S1_A_mean['power']
Feb_S1_A_mean['time_series']=Feb_S1_A_mean['time_series']/60

Mar_S1_A['time']=pd.date_range(start='3/1/2018', end='4/1/2018', freq='1min', closed='left')
Mar_S1_A['time'] = Mar_S1_A['time'].astype('str') 
Mar_S1_A[['local_date','local_time']] = Mar_S1_A.time.str.split(" ",expand=True,)
Mar_S1_A_mean=Mar_S1_A.groupby(Mar_S1_A.local_time).mean()
del Mar_S1_A_mean['Unnamed: 0']
Mar_S1_A_mean['time_series']=np.arange(0,len(Mar_S1_A_mean),1)
Mar_S1_A_mean=Mar_S1_A_mean.rename(columns={'0':'power'})
Mar_S1_A_mean['power']=Mar_S1_A_mean['power']
Mar_S1_A_mean['time_series']=Mar_S1_A_mean['time_series']/60

Apr_S1_A['time']=pd.date_range(start='4/1/2018', end='5/1/2018', freq='1min', closed='left')
Apr_S1_A['time'] = Apr_S1_A['time'].astype('str') 
Apr_S1_A[['local_date','local_time']] = Apr_S1_A.time.str.split(" ",expand=True,)
Apr_S1_A_mean=Apr_S1_A.groupby(Apr_S1_A.local_time).mean()
del Apr_S1_A_mean['Unnamed: 0']
Apr_S1_A_mean['time_series']=np.arange(0,len(Apr_S1_A_mean),1)
Apr_S1_A_mean=Apr_S1_A_mean.rename(columns={'0':'power'})
Apr_S1_A_mean['power']=Apr_S1_A_mean['power']
Apr_S1_A_mean['time_series']=Apr_S1_A_mean['time_series']/60

May_S1_A['time']=pd.date_range(start='5/1/2018', end='6/1/2018', freq='1min', closed='left')
May_S1_A['time'] = May_S1_A['time'].astype('str') 
May_S1_A[['local_date','local_time']] = May_S1_A.time.str.split(" ",expand=True,)
May_S1_A_mean=May_S1_A.groupby(May_S1_A.local_time).mean()
del May_S1_A_mean['Unnamed: 0']
May_S1_A_mean['time_series']=np.arange(0,len(May_S1_A_mean),1)
May_S1_A_mean=May_S1_A_mean.rename(columns={'0':'power'})
May_S1_A_mean['power']=May_S1_A_mean['power']
May_S1_A_mean['time_series']=May_S1_A_mean['time_series']/60

Jun_S1_A['time']=pd.date_range(start='6/1/2018', end='7/1/2018', freq='1min', closed='left')
Jun_S1_A['time'] = Jun_S1_A['time'].astype('str') 
Jun_S1_A[['local_date','local_time']] = Jun_S1_A.time.str.split(" ",expand=True,)
Jun_S1_A_mean=Jun_S1_A.groupby(Jun_S1_A.local_time).mean()
del Jun_S1_A_mean['Unnamed: 0']
Jun_S1_A_mean['time_series']=np.arange(0,len(Jun_S1_A_mean),1)
Jun_S1_A_mean=Jun_S1_A_mean.rename(columns={'0':'power'})
Jun_S1_A_mean['power']=Jun_S1_A_mean['power']
Jun_S1_A_mean['time_series']=Jun_S1_A_mean['time_series']/60

Jul_S1_A['time']=pd.date_range(start='7/1/2018', end='8/1/2018', freq='1min', closed='left')
Jul_S1_A['time'] = Jul_S1_A['time'].astype('str') 
Jul_S1_A[['local_date','local_time']] = Jul_S1_A.time.str.split(" ",expand=True,)
Jul_S1_A_mean=Jul_S1_A.groupby(Jul_S1_A.local_time).mean()
del Jul_S1_A_mean['Unnamed: 0']
Jul_S1_A_mean['time_series']=np.arange(0,len(Jul_S1_A_mean),1)
Jul_S1_A_mean=Jul_S1_A_mean.rename(columns={'0':'power'})
Jul_S1_A_mean['power']=Jul_S1_A_mean['power']
Jul_S1_A_mean['time_series']=Jul_S1_A_mean['time_series']/60

Aug_S1_A['time']=pd.date_range(start='8/1/2018', end='9/1/2018', freq='1min', closed='left')
Aug_S1_A['time'] = Aug_S1_A['time'].astype('str') 
Aug_S1_A[['local_date','local_time']] = Aug_S1_A.time.str.split(" ",expand=True,)
Aug_S1_A_mean=Aug_S1_A.groupby(Aug_S1_A.local_time).mean()
del Aug_S1_A_mean['Unnamed: 0']
Aug_S1_A_mean['time_series']=np.arange(0,len(Aug_S1_A_mean),1)
Aug_S1_A_mean=Aug_S1_A_mean.rename(columns={'0':'power'})
Aug_S1_A_mean['power']=Aug_S1_A_mean['power']
Aug_S1_A_mean['time_series']=Aug_S1_A_mean['time_series']/60

Sep_S1_A['time']=pd.date_range(start='9/1/2018', end='10/1/2018', freq='1min', closed='left')
Sep_S1_A['time'] = Sep_S1_A['time'].astype('str') 
Sep_S1_A[['local_date','local_time']] = Sep_S1_A.time.str.split(" ",expand=True,)
Sep_S1_A_mean=Sep_S1_A.groupby(Sep_S1_A.local_time).mean()
del Sep_S1_A_mean['Unnamed: 0']
Sep_S1_A_mean['time_series']=np.arange(0,len(Sep_S1_A_mean),1)
Sep_S1_A_mean=Sep_S1_A_mean.rename(columns={'0':'power'})
Sep_S1_A_mean['power']=Sep_S1_A_mean['power']
Sep_S1_A_mean['time_series']=Sep_S1_A_mean['time_series']/60

Oct_S1_A['time']=pd.date_range(start='10/1/2018', end='11/1/2018', freq='1min', closed='left')
Oct_S1_A['time'] = Oct_S1_A['time'].astype('str') 
Oct_S1_A[['local_date','local_time']] = Oct_S1_A.time.str.split(" ",expand=True,)
Oct_S1_A_mean=Oct_S1_A.groupby(Oct_S1_A.local_time).mean()
del Oct_S1_A_mean['Unnamed: 0']
Oct_S1_A_mean['time_series']=np.arange(0,len(Oct_S1_A_mean),1)
Oct_S1_A_mean=Oct_S1_A_mean.rename(columns={'0':'power'})
Oct_S1_A_mean['power']=Oct_S1_A_mean['power']
Oct_S1_A_mean['time_series']=Oct_S1_A_mean['time_series']/60

Nov_S1_A['time']=pd.date_range(start='11/1/2018', end='12/1/2018', freq='1min', closed='left')
Nov_S1_A['time'] = Nov_S1_A['time'].astype('str') 
Nov_S1_A[['local_date','local_time']] = Nov_S1_A.time.str.split(" ",expand=True,)
Nov_S1_A_mean=Nov_S1_A.groupby(Nov_S1_A.local_time).mean()
del Nov_S1_A_mean['Unnamed: 0']
Nov_S1_A_mean['time_series']=np.arange(0,len(Nov_S1_A_mean),1)
Nov_S1_A_mean=Nov_S1_A_mean.rename(columns={'0':'power'})
Nov_S1_A_mean['power']=Nov_S1_A_mean['power']
Nov_S1_A_mean['time_series']=Nov_S1_A_mean['time_series']/60

Dec_S1_A['time']=pd.date_range(start='12/1/2018', end='1/1/2019', freq='1min', closed='left')
Dec_S1_A['time'] = Dec_S1_A['time'].astype('str') 
Dec_S1_A[['local_date','local_time']] = Dec_S1_A.time.str.split(" ",expand=True,)
Dec_S1_A_mean=Dec_S1_A.groupby(Dec_S1_A.local_time).mean()
del Dec_S1_A_mean['Unnamed: 0']
Dec_S1_A_mean['time_series']=np.arange(0,len(Dec_S1_A_mean),1)
Dec_S1_A_mean=Dec_S1_A_mean.rename(columns={'0':'power'})
Dec_S1_A_mean['power']=Dec_S1_A_mean['power']
Dec_S1_A_mean['time_series']=Dec_S1_A_mean['time_series']/60
...
l2,=axs[0, 0].plot(Jan_S1_A_mean['time_series'], Jan_S1_A_mean['power'],color='blue',linewidth=1)
...
axs[0, 1].plot(Feb_S1_A_mean['time_series'], Feb_S1_A_mean['power'],color='blue',linewidth=1)
...
axs[0, 2].plot(Mar_S1_A_mean['time_series'], Jan_S1_A_mean['power'],color='blue',linewidth=1)
...
axs[0, 3].plot(Apr_S1_A_mean['time_series'], Apr_S1_A_mean['power'],color='blue',linewidth=1)
...
axs[1, 0].plot(May_S1_A_mean['time_series'], May_S1_A_mean['power'],color='blue',linewidth=1)
...
axs[1, 1].plot(Jun_S1_A_mean['time_series'], Jun_S1_A_mean['power'],color='blue',linewidth=1)
...
axs[1, 2].plot(Jul_S1_A_mean['time_series'], Jul_S1_A_mean['power'],color='blue',linewidth=1)
...
axs[1, 3].plot(Aug_S1_A_mean['time_series'], Aug_S1_A_mean['power'],color='blue',linewidth=1)
...
axs[2, 0].plot(Sep_S1_A_mean['time_series'], Sep_S1_A_mean['power'],color='blue',linewidth=1)
...
axs[2, 1].plot(Oct_S1_A_mean['time_series'], Oct_S1_A_mean['power'],color='blue',linewidth=1)
...
axs[2, 2].plot(Nov_S1_A_mean['time_series'], Nov_S1_A_mean['power'],color='blue',linewidth=1)
...
axs[2, 3].plot(Dec_S1_A_mean['time_series'], Dec_S1_A_mean['power'],color='blue',linewidth=1)
...
Jan_S1_A_mean_sort=Jan_S1_A_mean
Jan_S1_A_mean_sort=Jan_S1_A_mean.sort_values(['power'],ascending=False)
Jan_S1_A_mean_sort=Jan_S1_A_mean_sort.reset_index()
del Jan_S1_A_mean_sort['local_time']
del Jan_S1_A_mean_sort['time_series']
Jan_S1_A_mean_sort['index_1']=Jan_S1_A_mean_sort.index[()]
for i in range (0,len(Jan_S1_A_mean_sort),1):
     Jan_S1_A_mean_sort.loc[Jan_S1_A_mean_sort['index_1']>=0, 'index_2'] = Jan_S1_A_mean_sort['index_1']/(len(Jan_S1_A_mean_sort)-1)

Feb_S1_A_mean_sort=Feb_S1_A_mean
Feb_S1_A_mean_sort=Feb_S1_A_mean.sort_values(['power'],ascending=False)
Feb_S1_A_mean_sort=Feb_S1_A_mean_sort.reset_index()
del Feb_S1_A_mean_sort['local_time']
del Feb_S1_A_mean_sort['time_series']
Feb_S1_A_mean_sort['index_1']=Feb_S1_A_mean_sort.index[()]
for i in range (0,len(Feb_S1_A_mean_sort),1):
     Feb_S1_A_mean_sort.loc[Feb_S1_A_mean_sort['index_1']>=0, 'index_2'] = Feb_S1_A_mean_sort['index_1']/(len(Feb_S1_A_mean_sort)-1)

Mar_S1_A_mean_sort=Mar_S1_A_mean
Mar_S1_A_mean_sort=Mar_S1_A_mean.sort_values(['power'],ascending=False)
Mar_S1_A_mean_sort=Mar_S1_A_mean_sort.reset_index()
Mar_S1_A_mean_sort
del Mar_S1_A_mean_sort['local_time']
del Mar_S1_A_mean_sort['time_series']
Mar_S1_A_mean_sort['index_1']=Mar_S1_A_mean_sort.index[()]
for i in range (0,len(Mar_S1_A_mean_sort),1):
     Mar_S1_A_mean_sort.loc[Mar_S1_A_mean_sort['index_1']>=0, 'index_2'] = Mar_S1_A_mean_sort['index_1']/(len(Mar_S1_A_mean_sort)-1)
Apr_S1_A_mean_sort=Apr_S1_A_mean
Apr_S1_A_mean_sort=Apr_S1_A_mean.sort_values(['power'],ascending=False)
Apr_S1_A_mean_sort=Apr_S1_A_mean_sort.reset_index()
Apr_S1_A_mean_sort
del Apr_S1_A_mean_sort['local_time']
del Apr_S1_A_mean_sort['time_series']
Apr_S1_A_mean_sort['index_1']=Apr_S1_A_mean_sort.index[()]
for i in range (0,len(Apr_S1_A_mean_sort),1):
     Apr_S1_A_mean_sort.loc[Apr_S1_A_mean_sort['index_1']>=0, 'index_2'] = Apr_S1_A_mean_sort['index_1']/(len(Apr_S1_A_mean_sort)-1)
May_S1_A_mean_sort=May_S1_A_mean
May_S1_A_mean_sort=May_S1_A_mean.sort_values(['power'],ascending=False)
May_S1_A_mean_sort=May_S1_A_mean_sort.reset_index()
May_S1_A_mean_sort
del May_S1_A_mean_sort['local_time']
del May_S1_A_mean_sort['time_series']
May_S1_A_mean_sort['index_1']=May_S1_A_mean_sort.index[()]
for i in range (0,len(May_S1_A_mean_sort),1):
     May_S1_A_mean_sort.loc[May_S1_A_mean_sort['index_1']>=0, 'index_2'] = May_S1_A_mean_sort['index_1']/(len(May_S1_A_mean_sort)-1)
Jun_S1_A_mean_sort=Jun_S1_A_mean
Jun_S1_A_mean_sort=Jun_S1_A_mean.sort_values(['power'],ascending=False)
Jun_S1_A_mean_sort=Jun_S1_A_mean_sort.reset_index()
Jun_S1_A_mean_sort
del Jun_S1_A_mean_sort['local_time']
del Jun_S1_A_mean_sort['time_series']
Jun_S1_A_mean_sort['index_1']=Jun_S1_A_mean_sort.index[()]
for i in range (0,len(Jun_S1_A_mean_sort),1):
     Jun_S1_A_mean_sort.loc[Jun_S1_A_mean_sort['index_1']>=0, 'index_2'] = Jun_S1_A_mean_sort['index_1']/(len(Jun_S1_A_mean_sort)-1)
Jul_S1_A_mean_sort=Jul_S1_A_mean
Jul_S1_A_mean_sort=Jul_S1_A_mean.sort_values(['power'],ascending=False)
Jul_S1_A_mean_sort=Jul_S1_A_mean_sort.reset_index()
Jul_S1_A_mean_sort
del Jul_S1_A_mean_sort['local_time']
del Jul_S1_A_mean_sort['time_series']
Jul_S1_A_mean_sort['index_1']=Jul_S1_A_mean_sort.index[()]
for i in range (0,len(Jul_S1_A_mean_sort),1):
     Jul_S1_A_mean_sort.loc[Jul_S1_A_mean_sort['index_1']>=0, 'index_2'] = Jul_S1_A_mean_sort['index_1']/(len(Jul_S1_A_mean_sort)-1)
Aug_S1_A_mean_sort=Aug_S1_A_mean
Aug_S1_A_mean_sort=Aug_S1_A_mean.sort_values(['power'],ascending=False)
Aug_S1_A_mean_sort=Aug_S1_A_mean_sort.reset_index()
Aug_S1_A_mean_sort
del Aug_S1_A_mean_sort['local_time']
del Aug_S1_A_mean_sort['time_series']
Aug_S1_A_mean_sort['index_1']=Aug_S1_A_mean_sort.index[()]
for i in range (0,len(Aug_S1_A_mean_sort),1):
     Aug_S1_A_mean_sort.loc[Aug_S1_A_mean_sort['index_1']>=0, 'index_2'] = Aug_S1_A_mean_sort['index_1']/(len(Aug_S1_A_mean_sort)-1)
Sep_S1_A_mean_sort=Sep_S1_A_mean
Sep_S1_A_mean_sort=Sep_S1_A_mean.sort_values(['power'],ascending=False)
Sep_S1_A_mean_sort=Sep_S1_A_mean_sort.reset_index()
Sep_S1_A_mean_sort
del Sep_S1_A_mean_sort['local_time']
del Sep_S1_A_mean_sort['time_series']
Sep_S1_A_mean_sort['index_1']=Sep_S1_A_mean_sort.index[()]
for i in range (0,len(Sep_S1_A_mean_sort),1):
     Sep_S1_A_mean_sort.loc[Sep_S1_A_mean_sort['index_1']>=0, 'index_2'] = Sep_S1_A_mean_sort['index_1']/(len(Sep_S1_A_mean_sort)-1)
Oct_S1_A_mean_sort=Oct_S1_A_mean
Oct_S1_A_mean_sort=Oct_S1_A_mean.sort_values(['power'],ascending=False)
Oct_S1_A_mean_sort=Oct_S1_A_mean_sort.reset_index()
Oct_S1_A_mean_sort
del Oct_S1_A_mean_sort['local_time']
del Oct_S1_A_mean_sort['time_series']
Oct_S1_A_mean_sort['index_1']=Oct_S1_A_mean_sort.index[()]
for i in range (0,len(Oct_S1_A_mean_sort),1):
     Oct_S1_A_mean_sort.loc[Oct_S1_A_mean_sort['index_1']>=0, 'index_2'] = Oct_S1_A_mean_sort['index_1']/(len(Oct_S1_A_mean_sort)-1)
Nov_S1_A_mean_sort=Nov_S1_A_mean
Nov_S1_A_mean_sort=Nov_S1_A_mean.sort_values(['power'],ascending=False)
Nov_S1_A_mean_sort=Nov_S1_A_mean_sort.reset_index()
Nov_S1_A_mean_sort
del Nov_S1_A_mean_sort['local_time']
del Nov_S1_A_mean_sort['time_series']
Nov_S1_A_mean_sort['index_1']=Nov_S1_A_mean_sort.index[()]
for i in range (0,len(Nov_S1_A_mean_sort),1):
     Nov_S1_A_mean_sort.loc[Nov_S1_A_mean_sort['index_1']>=0, 'index_2'] = Nov_S1_A_mean_sort['index_1']/(len(Nov_S1_A_mean_sort)-1)
Dec_S1_A_mean_sort=Dec_S1_A_mean
Dec_S1_A_mean_sort=Dec_S1_A_mean.sort_values(['power'],ascending=False)
Dec_S1_A_mean_sort=Dec_S1_A_mean_sort.reset_index()
Dec_S1_A_mean_sort
del Dec_S1_A_mean_sort['local_time']
del Dec_S1_A_mean_sort['time_series']
Dec_S1_A_mean_sort['index_1']=Dec_S1_A_mean_sort.index[()]
for i in range (0,len(Dec_S1_A_mean_sort),1):
     Dec_S1_A_mean_sort.loc[Dec_S1_A_mean_sort['index_1']>=0, 'index_2'] = Dec_S1_A_mean_sort['index_1']/(len(Dec_S1_A_mean_sort)-1)
...
l2,=axs[0, 0].plot(Jan_S1_A_mean_sort['index_2'], Jan_S1_A_mean_sort['power'],color='blue',linewidth=1)
axs[0, 0].set_title('January')
#axs[0, 0].set_yticks([0, 5, 10, 15, 20, 25])
...
axs[0, 1].plot(Feb_S1_A_mean_sort['index_2'], Feb_S1_A_mean_sort['power'],color='blue',linewidth=1)
axs[0, 1].set_title('February')
...
axs[0, 2].plot(Mar_S1_A_mean_sort['index_2'], Mar_S1_A_mean_sort['power'],color='blue',linewidth=1)
axs[0, 2].set_title('March')
...
axs[1, 0].plot(Apr_S1_A_mean_sort['index_2'], Apr_S1_A_mean_sort['power'],color='blue',linewidth=1)
...
axs[1, 1].plot(May_S1_A_mean_sort['index_2'], May_S1_A_mean_sort['power'],color='blue',linewidth=1)
...
axs[1, 2].plot(Jun_S1_A_mean_sort['index_2'], Jun_S1_A_mean_sort['power'],color='blue',linewidth=1)
...
axs[2, 0].plot(Jul_S1_A_mean_sort['index_2'], Jul_S1_A_mean_sort['power'],color='blue',linewidth=1)
...
axs[2, 1].plot(Aug_S1_A_mean_sort['index_2'], Aug_S1_A_mean_sort['power'],color='blue',linewidth=1)
...
axs[2, 2].plot(Sep_S1_A_mean_sort['index_2'], Sep_S1_A_mean_sort['power'],color='blue',linewidth=1)
...
axs[3, 0].plot(Oct_S1_A_mean_sort['index_2'], Oct_S1_A_mean_sort['power'],color='blue',linewidth=1)
...
axs[3, 1].plot(Nov_S1_A_mean_sort['index_2'], Nov_S1_A_mean_sort['power'],color='blue',linewidth=1)
...
axs[3, 2].plot(Dec_S1_A_mean_sort['index_2'], Dec_S1_A_mean_sort['power'],color='blue',linewidth=1)
