...
# -*- coding: utf-8 -*-
"""
Created on Tue Jun  1 14:08:12 2021

@author: alejandrosoto
"""

import pandas as pd
Jan=pd.read_csv('Jan_S9_o.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Feb=pd.read_csv('Feb_S9_o.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Mar=pd.read_csv('Mar_S9_o.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Apr=pd.read_csv('Apr_S9_o.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
May=pd.read_csv('May_S9_o.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Jun=pd.read_csv('Jun_S9_o.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Jul=pd.read_csv('Jul_S9_o.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Aug=pd.read_csv('Aug_S9_o.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Sep=pd.read_csv('Sep_S9_o.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
#Oct=pd.read_csv('Oct_S9_o.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
#Nov=pd.read_csv('Nov_S9_o.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
#Dec=pd.read_csv('Dec_S9_o.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
...
Jan_1=pd.read_csv('Jan_S9_t.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Feb_1=pd.read_csv('Feb_S9_t.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Mar_1=pd.read_csv('Mar_S9_t.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Apr_1=pd.read_csv('Apr_S9_t.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
May_1=pd.read_csv('May_S9_t.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Jun_1=pd.read_csv('Jun_S9_t.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Jul_1=pd.read_csv('Jul_S9_t.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Aug_1=pd.read_csv('Aug_S9_t.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Sep_1=pd.read_csv('Sep_S9_t.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Oct_1=pd.read_csv('Oct_S9_t.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Nov_1=pd.read_csv('Nov_S9_t.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Dec_1=pd.read_csv('Dec_S9_t.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
...
Jan_2=pd.read_csv('Jan_S9_t1.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Feb_2=pd.read_csv('Feb_S9_t1.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Mar_2=pd.read_csv('Mar_S9_t1.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Apr_2=pd.read_csv('Apr_S9_t1.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
May_2=pd.read_csv('May_S9_t1.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Jun_2=pd.read_csv('Jun_S9_t1.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Jul_2=pd.read_csv('Jul_S9_t1.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Aug_2=pd.read_csv('Aug_S9_t1.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Sep_2=pd.read_csv('Sep_S9_t1.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Oct_2=pd.read_csv('Oct_S9_t1.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Nov_2=pd.read_csv('Nov_S9_t1.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Dec_2=pd.read_csv('Dec_S9_t1.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Jan_2['0'] = Jan_2['0'].astype(float)
Jan_2['Unnamed: 0'] = Jan_2['Unnamed: 0'].astype(float)
Feb_2['0'] = Feb_2['0'].astype(float)
Feb_2['Unnamed: 0'] = Feb_2['Unnamed: 0'].astype(float)
Mar_2['0'] = Mar_2['0'].astype(float)
Mar_2['Unnamed: 0'] = Mar_2['Unnamed: 0'].astype(float)
Apr_2['0'] = Apr_2['0'].astype(float)
Apr_2['Unnamed: 0'] = Apr_2['Unnamed: 0'].astype(float)
May_2['0'] = May_2['0'].astype(float)
May_2['Unnamed: 0'] = May_2['Unnamed: 0'].astype(float)
Jun_2['0'] = Jun_2['0'].astype(float)
Jun_2['Unnamed: 0'] = Jun_2['Unnamed: 0'].astype(float)
Jul_2['0'] = Jul_2['0'].astype(float)
Jul_2['Unnamed: 0'] = Jul_2['Unnamed: 0'].astype(float)
Aug_2['0'] = Aug_2['0'].astype(float)
Aug_2['Unnamed: 0'] = Aug_2['Unnamed: 0'].astype(float)
Sep_2['0'] = Sep_2['0'].astype(float)
Sep_2['Unnamed: 0'] = Sep_2['Unnamed: 0'].astype(float)
Oct_2['0'] = Oct_2['0'].astype(float)
Oct_2['Unnamed: 0'] = Oct_2['Unnamed: 0'].astype(float)
Nov_2['0'] = Nov_2['0'].astype(float)
Nov_2['Unnamed: 0'] = Nov_2['Unnamed: 0'].astype(float) 
Dec_2['0'] = Dec_2['0'].astype(float)
...
import numpy as np
Jan_2['time_series']=np.arange(0,len(Jan),1)
Jan_2['time_series']=Jan_2['time_series']/60
Feb_2['time_series']=np.arange(0,len(Feb),1)
Feb_2['time_series']=Feb_2['time_series']/60
Mar_2['time_series']=np.arange(0,len(Mar),1)
Mar_2['time_series']=Mar_2['time_series']/60
Apr_2['time_series']=np.arange(0,len(Apr),1)
Apr_2['time_series']=Apr_2['time_series']/60
May_2['time_series']=np.arange(0,len(May),1)
May_2['time_series']=May_2['time_series']/60
Jun_2['time_series']=np.arange(0,len(Jun),1)
Jun_2['time_series']=Jun_2['time_series']/60
Jul_2['time_series']=np.arange(0,len(Jul),1)
Jul_2['time_series']=Jul_2['time_series']/60
Aug_2['time_series']=np.arange(0,len(Aug),1)
Aug_2['time_series']=Aug_2['time_series']/60
Sep_2['time_series']=np.arange(0,len(Sep),1)
Sep_2['time_series']=Sep_2['time_series']/60
Oct_2['time_series']=np.arange(0,len(Oct_2),1)
Oct_2['time_series']=Oct_2['time_series']/60
Nov_2['time_series']=np.arange(0,len(Nov_2),1)
Nov_2['time_series']=Nov_2['time_series']/60
Dec_2['time_series']=np.arange(0,len(Dec_2),1)
Dec_2['time_series']=Dec_2['time_series']/60


Jan_S4=pd.read_csv('Jan_S9_A.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Feb_S4=pd.read_csv('Feb_S9_A.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Mar_S4=pd.read_csv('Mar_S9_A.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Apr_S4=pd.read_csv('Apr_S9_A.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
May_S4=pd.read_csv('May_S9_A.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Jun_S4=pd.read_csv('Jun_S9_A.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Jul_S4=pd.read_csv('Jul_S9_A.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Aug_S4=pd.read_csv('Aug_S9_A.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Sep_S4=pd.read_csv('Sep_S9_A.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Oct_S4=pd.read_csv('Oct_S9_A.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Nov_S4=pd.read_csv('Nov_S9_A.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Dec_S4=pd.read_csv('Dec_S9_A.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
...
l2,=axs[0, 0].plot(Jan_2['time_series'], Jan_2['0'],color='#c7fdb5',linewidth=1)
l3,=axs[0, 0].plot(Jan_S4_mean['time_series'], Jan_S4_mean['power'],color='blue',linewidth=1)
...
axs[0, 1].plot(Feb_2['time_series'], Feb_2['0'],color='#c7fdb5',linewidth=1)
...
axs[0, 2].plot(Mar_2['time_series'], Mar_2['0'],color='#c7fdb5',linewidth=1)
...
axs[0, 3].plot(Apr_2['time_series'], Apr_2['0'],color='#c7fdb5',linewidth=1)
...
axs[1, 0].plot(May_2['time_series'], May_2['0'],color='#c7fdb5',linewidth=1)
...
axs[1, 1].plot(Jun_2['time_series'], Jun_2['0'],color='#c7fdb5',linewidth=1)
...
axs[1, 2].plot(Jul_2['time_series'], Jul_2['0'],color='#c7fdb5',linewidth=1)
...
axs[1, 3].plot(Aug_2['time_series'], Aug_2['0'],color='#c7fdb5',linewidth=1)
...
axs[2, 0].plot(Sep_2['time_series'], Sep_2['0'],color='#c7fdb5',linewidth=1)
...
axs[2, 1].plot(Oct_2['time_series'], Oct_2['0'],color='#c7fdb5',linewidth=1)
axs[2, 1].set_title('October')
axs[2, 1].set_xticks([0, 10, 20])
axs[2, 1].set_yticks([0, 200, 400])
...
axs[2, 2].plot(Nov_2['time_series'], Nov_2['0'],color='#c7fdb5',linewidth=1)
...
axs[2, 3].plot(Dec_2['time_series'], Dec_2['0'],color='#c7fdb5',linewidth=1)
...
axs[2, 3].set_yticks([0, 200, 400])
for ax in axs.flat:
    ax.set(xlabel='Local time (h)', ylabel='Power (W)')
#Hide x labels and tick labels for top plots and y ticks for right plots.
#for ax in axs.flat:
    #ax.label_outer()
plt.subplots_adjust(bottom=0.1, right=3, top=2, hspace=0.55, wspace = 0.2)
plt.figure(figsize=(25,50))
plt.tight_layout(pad=0.4, w_pad=1, h_pad=1.0)
#plt.savefig('profiles_temp_raq_2018.png', dpi=200,bbox_inches="tight")

ax.legend(handles = [l0,l1,l2,l3] , labels=['atypical', 'occasional', 'occasional 1', 'average'],bbox_to_anchor=(1.5,4),fancybox=False,loc='upper right', shadow=False)
...
Jan_2_sort=Jan_2
Jan_2_sort=Jan_2.sort_values(['0'],ascending=False)
Jan_2_sort=Jan_2_sort.reset_index()
Jan_2_sort
del Jan_2_sort['index']
del Jan_2_sort['time_series']
Jan_2_sort['index_1']=Jan_2_sort.index[()]
for i in range (0,len(Jan_2_sort),1):
     Jan_2_sort.loc[Jan_2_sort['index_1']>=0, 'index_2'] = Jan_2_sort['index_1']/(len(Jan_2_sort)-1)
Feb_2_sort=Feb_2
Feb_2_sort=Feb_2.sort_values(['0'],ascending=False)
Feb_2_sort=Feb_2_sort.reset_index()
del Feb_2_sort['index']
del Feb_2_sort['time_series']
Feb_2_sort['index_1']=Feb_2_sort.index[()]
for i in range (0,len(Feb_2_sort),1):
     Feb_2_sort.loc[Feb_2_sort['index_1']>=0, 'index_2'] = Feb_2_sort['index_1']/(len(Feb_2_sort)-1)
Mar_2_sort=Mar_2
Mar_2_sort=Mar_2.sort_values(['0'],ascending=False)
Mar_2_sort=Mar_2_sort.reset_index()
Mar_2_sort
del Mar_2_sort['index']
del Mar_2_sort['time_series']
Mar_2_sort['index_1']=Mar_2_sort.index[()]
for i in range (0,len(Mar_2_sort),1):
     Mar_2_sort.loc[Mar_2_sort['index_1']>=0, 'index_2'] = Mar_2_sort['index_1']/(len(Mar_2_sort)-1)
Apr_2_sort=Apr_2
Apr_2_sort=Apr_2.sort_values(['0'],ascending=False)
Apr_2_sort=Apr_2_sort.reset_index()
Apr_2_sort
del Apr_2_sort['index']
del Apr_2_sort['time_series']
Apr_2_sort['index_1']=Apr_2_sort.index[()]
for i in range (0,len(Apr_2_sort),1):
     Apr_2_sort.loc[Apr_2_sort['index_1']>=0, 'index_2'] = Apr_2_sort['index_1']/(len(Apr_2_sort)-1)
May_2_sort=May_2
May_2_sort=May_2.sort_values(['0'],ascending=False)
May_2_sort=May_2_sort.reset_index()
May_2_sort
del May_2_sort['index']
del May_2_sort['time_series']
May_2_sort['index_1']=May_2_sort.index[()]
for i in range (0,len(May_2_sort),1):
     May_2_sort.loc[May_2_sort['index_1']>=0, 'index_2'] = May_2_sort['index_1']/(len(May_2_sort)-1)
Jun_2_sort=Jun_2
Jun_2_sort=Jun_2.sort_values(['0'],ascending=False)
Jun_2_sort=Jun_2_sort.reset_index()
Jun_2_sort
del Jun_2_sort['index']
del Jun_2_sort['time_series']
Jun_2_sort['index_1']=Jun_2_sort.index[()]
for i in range (0,len(Jun_2_sort),1):
     Jun_2_sort.loc[Jun_2_sort['index_1']>=0, 'index_2'] = Jun_2_sort['index_1']/(len(Jun_2_sort)-1)
Jul_2_sort=Jul_2
Jul_2_sort=Jul_2.sort_values(['0'],ascending=False)
Jul_2_sort=Jul_2_sort.reset_index()
Jul_2_sort
del Jul_2_sort['index']
del Jul_2_sort['time_series']
Jul_2_sort['index_1']=Jul_2_sort.index[()]
for i in range (0,len(Jul_2_sort),1):
     Jul_2_sort.loc[Jul_2_sort['index_1']>=0, 'index_2'] = Jul_2_sort['index_1']/(len(Jul_2_sort)-1)
Aug_2_sort=Aug_2
Aug_2_sort=Aug_2.sort_values(['0'],ascending=False)
Aug_2_sort=Aug_2_sort.reset_index()
Aug_2_sort
del Aug_2_sort['index']
del Aug_2_sort['time_series']
Aug_2_sort['index_1']=Aug_2_sort.index[()]
for i in range (0,len(Aug_2_sort),1):
     Aug_2_sort.loc[Aug_2_sort['index_1']>=0, 'index_2'] = Aug_2_sort['index_1']/(len(Aug_2_sort)-1)
Sep_2_sort=Sep_2
Sep_2_sort=Sep_2.sort_values(['0'],ascending=False)
Sep_2_sort=Sep_2_sort.reset_index()
Sep_2_sort
del Sep_2_sort['index']
del Sep_2_sort['time_series']
Sep_2_sort['index_1']=Sep_2_sort.index[()]
for i in range (0,len(Sep_2_sort),1):
     Sep_2_sort.loc[Sep_2_sort['index_1']>=0, 'index_2'] = Sep_2_sort['index_1']/(len(Sep_2_sort)-1)
Oct_2_sort=Oct_2
Oct_2_sort=Oct_2.sort_values(['0'],ascending=False)
Oct_2_sort=Oct_2_sort.reset_index()
Oct_2_sort
del Oct_2_sort['index']
del Oct_2_sort['time_series']
Oct_2_sort['index_1']=Oct_2_sort.index[()]
for i in range (0,len(Oct_2_sort),1):
     Oct_2_sort.loc[Oct_2_sort['index_1']>=0, 'index_2'] = Oct_2_sort['index_1']/(len(Oct_2_sort)-1)
Nov_2_sort=Nov_2
Nov_2_sort=Nov_2.sort_values(['0'],ascending=False)
Nov_2_sort=Nov_2_sort.reset_index()
Nov_2_sort
del Nov_2_sort['index']
del Nov_2_sort['time_series']
Nov_2_sort['index_1']=Nov_2_sort.index[()]
for i in range (0,len(Nov_2_sort),1):
     Nov_2_sort.loc[Nov_2_sort['index_1']>=0, 'index_2'] = Nov_2_sort['index_1']/(len(Nov_2_sort)-1)
Dec_2_sort=Dec_2
Dec_2_sort=Dec_2.sort_values(['0'],ascending=False)
Dec_2_sort=Dec_2_sort.reset_index()
Dec_2_sort
del Dec_2_sort['index']
del Dec_2_sort['time_series']
Dec_2_sort['index_1']=Dec_2_sort.index[()]
for i in range (0,len(Dec_2_sort),1):
     Dec_2_sort.loc[Dec_2_sort['index_1']>=0, 'index_2'] = Dec_2_sort['index_1']/(len(Dec_2_sort)-1)
...
l2,=axs[0, 0].plot(Jan_2_sort['index_2'], Jan_2_sort['0'],color='#c7fdb5',linewidth=1)
l3,=axs[0, 0].plot(Jan_S4_mean_sort['index_2'], Jan_S4_mean_sort['power'],color='blue',linewidth=1)
axs[0, 0].set_title('January')
#axs[0, 0].set_yticks([0, 5, 10, 15, 20, 25])
...
axs[0, 1].plot(Feb_2_sort['index_2'], Feb_2_sort['0'],color='#c7fdb5',linewidth=1)
...
axs[0, 2].plot(Mar_2_sort['index_2'], Mar_2_sort['0'],color='#c7fdb5',linewidth=1)
...
axs[0, 1].plot(Apr_2_sort['index_2'], Apr_2_sort['0'],color='#c7fdb5',linewidth=1)
...
axs[1, 1].plot(May_2_sort['index_2'], May_2_sort['0'],color='#c7fdb5',linewidth=1)
...
axs[1, 2].plot(Jun_2_sort['index_2'], Jun_2_sort['0'],color='#c7fdb5',linewidth=1)
...
axs[2, 0].plot(Jul_2_sort['index_2'], Jul_2_sort['0'],color='#c7fdb5',linewidth=1)
...
axs[2, 1].plot(Aug_2_sort['index_2'], Aug_2_sort['0'],color='#c7fdb5',linewidth=1)
...
axs[2, 2].plot(Sep_2_sort['index_2'], Sep_2_sort['0'],color='#c7fdb5',linewidth=1)
...
axs[3, 0].plot(Oct_2_sort['index_2'], Oct_2_sort['0'],color='#c7fdb5',linewidth=1)
...
axs[3, 1].plot(Nov_2_sort['index_2'], Nov_2_sort['0'],color='#c7fdb5',linewidth=1)
...
axs[3, 2].plot(Dec_2_sort['index_2'], Dec_2_sort['0'],color='#c7fdb5',linewidth=1)
...
ax.legend(handles = [l0,l1,l2,l3] , labels=['atypical', 'occasional', 'ocasional 1', 'average'],bbox_to_anchor=(1.5,5.5),fancybox=False,loc='upper right', shadow=False)
#plt.savefig('profiles_temp_raq_2018.png', dpi=200,bbox_inches="tight")
