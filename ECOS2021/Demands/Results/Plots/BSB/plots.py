...
# -*- coding: utf-8 -*-
"""
Created on Tue Jun  1 17:39:38 2021

@author: alejandrosoto
"""

import pandas as pd
Jan=pd.read_csv('Ocasional_Day/Jan_BSB_o.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Feb=pd.read_csv('Ocasional_Day/Feb_BSB_o.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Mar=pd.read_csv('Ocasional_Day/Mar_BSB_o.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Apr=pd.read_csv('Ocasional_Day/Apr_BSB_o.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
May=pd.read_csv('Ocasional_Day/May_BSB_o.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Jun=pd.read_csv('Ocasional_Day/Jun_BSB_o.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Jul=pd.read_csv('Ocasional_Day/Jul_BSB_o.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Aug=pd.read_csv('Ocasional_Day/Aug_BSB_o.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Sep=pd.read_csv('Ocasional_Day/Sep_BSB_o.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Oct=pd.read_csv('Ocasional_Day/Oct_BSB_o.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Nov=pd.read_csv('Ocasional_Day/Nov_BSB_o.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Dec=pd.read_csv('Ocasional_Day/Dec_BSB_o.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
...
import pandas as pd
Jan_1=pd.read_csv('Typical_Day/Jan_BSB_t.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Feb_1=pd.read_csv('Typical_Day/Feb_BSB_t.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Mar_1=pd.read_csv('Typical_Day/Mar_BSB_t.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Apr_1=pd.read_csv('Typical_Day/Apr_BSB_t.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
May_1=pd.read_csv('Typical_Day/May_BSB_t.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Jun_1=pd.read_csv('Typical_Day/Jun_BSB_t.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Jul_1=pd.read_csv('Typical_Day/Jul_BSB_t.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Aug_1=pd.read_csv('Typical_Day/Aug_BSB_t.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Sep_1=pd.read_csv('Typical_Day/Sep_BSB_t.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Oct_1=pd.read_csv('Typical_Day/Oct_BSB_t.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Nov_1=pd.read_csv('Typical_Day/Nov_BSB_t.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Dec_1=pd.read_csv('Typical_Day/Dec_BSB_t.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
...
Jan_BS_B=pd.read_csv('Jan_BS_B.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Feb_BS_B=pd.read_csv('Feb_BS_B.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Mar_BS_B=pd.read_csv('Mar_BS_B.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Apr_BS_B=pd.read_csv('Apr_BS_B.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
May_BS_B=pd.read_csv('May_BS_B.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Jun_BS_B=pd.read_csv('Jun_BS_B.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Jul_BS_B=pd.read_csv('Jul_BS_B.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Aug_BS_B=pd.read_csv('Aug_BS_B.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Sep_BS_B=pd.read_csv('Sep_BS_B.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Oct_BS_B=pd.read_csv('Oct_BS_B.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Nov_BS_B=pd.read_csv('Nov_BS_B.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Dec_BS_B=pd.read_csv('Dec_BS_B.csv', sep=',', decimal=',', encoding='latin1', error_bad_lines=False)
Jan_BS_B['0'] = Jan_BS_B['0'].astype(float)
Jan_BS_B['Unnamed: 0'] = Jan_BS_B['Unnamed: 0'].astype(float)
Feb_BS_B['0'] = Feb_BS_B['0'].astype(float)
Feb_BS_B['Unnamed: 0'] = Feb_BS_B['Unnamed: 0'].astype(float)
Mar_BS_B['0'] = Mar_BS_B['0'].astype(float)
Mar_BS_B['Unnamed: 0'] = Mar_BS_B['Unnamed: 0'].astype(float)
Apr_BS_B['0'] = Apr_BS_B['0'].astype(float)
Apr_BS_B['Unnamed: 0'] = Apr_BS_B['Unnamed: 0'].astype(float)
May_BS_B['0'] = May_BS_B['0'].astype(float)
May_BS_B['Unnamed: 0'] = May_BS_B['Unnamed: 0'].astype(float)
Jun_BS_B['0'] = Jun_BS_B['0'].astype(float)
Jun_BS_B['Unnamed: 0'] = Jun_BS_B['Unnamed: 0'].astype(float)
Jul_BS_B['0'] = Jul_BS_B['0'].astype(float)
Jul_BS_B['Unnamed: 0'] = Jul_BS_B['Unnamed: 0'].astype(float)
Aug_BS_B['0'] = Aug_BS_B['0'].astype(float)
Aug_BS_B['Unnamed: 0'] = Aug_BS_B['Unnamed: 0'].astype(float)
Sep_BS_B['0'] = Sep_BS_B['0'].astype(float)
Sep_BS_B['Unnamed: 0'] = Sep_BS_B['Unnamed: 0'].astype(float)
Oct_BS_B['0'] = Oct_BS_B['0'].astype(float)
Oct_BS_B['Unnamed: 0'] = Oct_BS_B['Unnamed: 0'].astype(float)
Nov_BS_B['0'] = Nov_BS_B['0'].astype(float)
Nov_BS_B['Unnamed: 0'] = Nov_BS_B['Unnamed: 0'].astype(float) 
Dec_BS_B['0'] = Dec_BS_B['0'].astype(float)
Dec_BS_B['Unnamed: 0'] = Dec_BS_B['Unnamed: 0'].astype(float)

Jan_BS_B['time']=pd.date_range(start='1/1/2018', end='2/1/2018', freq='1min', closed='left')
Jan_BS_B['time'] = Jan_BS_B['time'].astype('str') 
Jan_BS_B[['local_date','local_time']] = Jan_BS_B.time.str.split(" ",expand=True,)
Jan_BS_B_mean=Jan_BS_B.groupby(Jan_BS_B.local_time).mean()
del Jan_BS_B_mean['Unnamed: 0']
Jan_BS_B_mean['time_series']=np.arange(0,len(Jan_BS_B_mean),1)
Jan_BS_B_mean=Jan_BS_B_mean.rename(columns={'0':'power'})
Jan_BS_B_mean['power']=Jan_BS_B_mean['power']
Jan_BS_B_mean['time_series']=Jan_BS_B_mean['time_series']/60

Feb_BS_B['time']=pd.date_range(start='2/1/2018', end='3/1/2018', freq='1min', closed='left')
Feb_BS_B['time'] = Feb_BS_B['time'].astype('str') 
Feb_BS_B[['local_date','local_time']] = Feb_BS_B.time.str.split(" ",expand=True,)
Feb_BS_B_mean=Feb_BS_B.groupby(Feb_BS_B.local_time).mean()
del Feb_BS_B_mean['Unnamed: 0']
Feb_BS_B_mean['time_series']=np.arange(0,len(Feb_BS_B_mean),1)
Feb_BS_B_mean=Feb_BS_B_mean.rename(columns={'0':'power'})
Feb_BS_B_mean['power']=Feb_BS_B_mean['power']
Feb_BS_B_mean['time_series']=Feb_BS_B_mean['time_series']/60

Mar_BS_B['time']=pd.date_range(start='3/1/2018', end='4/1/2018', freq='1min', closed='left')
Mar_BS_B['time'] = Mar_BS_B['time'].astype('str') 
Mar_BS_B[['local_date','local_time']] = Mar_BS_B.time.str.split(" ",expand=True,)
Mar_BS_B_mean=Mar_BS_B.groupby(Mar_BS_B.local_time).mean()
del Mar_BS_B_mean['Unnamed: 0']
Mar_BS_B_mean['time_series']=np.arange(0,len(Mar_BS_B_mean),1)
Mar_BS_B_mean=Mar_BS_B_mean.rename(columns={'0':'power'})
Mar_BS_B_mean['power']=Mar_BS_B_mean['power']
Mar_BS_B_mean['time_series']=Mar_BS_B_mean['time_series']/60

Apr_BS_B['time']=pd.date_range(start='4/1/2018', end='5/1/2018', freq='1min', closed='left')
Apr_BS_B['time'] = Apr_BS_B['time'].astype('str') 
Apr_BS_B[['local_date','local_time']] = Apr_BS_B.time.str.split(" ",expand=True,)
Apr_BS_B_mean=Apr_BS_B.groupby(Apr_BS_B.local_time).mean()
del Apr_BS_B_mean['Unnamed: 0']
Apr_BS_B_mean['time_series']=np.arange(0,len(Apr_BS_B_mean),1)
Apr_BS_B_mean=Apr_BS_B_mean.rename(columns={'0':'power'})
Apr_BS_B_mean['power']=Apr_BS_B_mean['power']
Apr_BS_B_mean['time_series']=Apr_BS_B_mean['time_series']/60

May_BS_B['time']=pd.date_range(start='5/1/2018', end='6/1/2018', freq='1min', closed='left')
May_BS_B['time'] = May_BS_B['time'].astype('str') 
May_BS_B[['local_date','local_time']] = May_BS_B.time.str.split(" ",expand=True,)
May_BS_B_mean=May_BS_B.groupby(May_BS_B.local_time).mean()
del May_BS_B_mean['Unnamed: 0']
May_BS_B_mean['time_series']=np.arange(0,len(May_BS_B_mean),1)
May_BS_B_mean=May_BS_B_mean.rename(columns={'0':'power'})
May_BS_B_mean['power']=May_BS_B_mean['power']
May_BS_B_mean['time_series']=May_BS_B_mean['time_series']/60

Jun_BS_B['time']=pd.date_range(start='6/1/2018', end='7/1/2018', freq='1min', closed='left')
Jun_BS_B['time'] = Jun_BS_B['time'].astype('str') 
Jun_BS_B[['local_date','local_time']] = Jun_BS_B.time.str.split(" ",expand=True,)
Jun_BS_B_mean=Jun_BS_B.groupby(Jun_BS_B.local_time).mean()
del Jun_BS_B_mean['Unnamed: 0']
Jun_BS_B_mean['time_series']=np.arange(0,len(Jun_BS_B_mean),1)
Jun_BS_B_mean=Jun_BS_B_mean.rename(columns={'0':'power'})
Jun_BS_B_mean['power']=Jun_BS_B_mean['power']
Jun_BS_B_mean['time_series']=Jun_BS_B_mean['time_series']/60

Jul_BS_B['time']=pd.date_range(start='7/1/2018', end='8/1/2018', freq='1min', closed='left')
Jul_BS_B['time'] = Jul_BS_B['time'].astype('str') 
Jul_BS_B[['local_date','local_time']] = Jul_BS_B.time.str.split(" ",expand=True,)
Jul_BS_B_mean=Jul_BS_B.groupby(Jul_BS_B.local_time).mean()
del Jul_BS_B_mean['Unnamed: 0']
Jul_BS_B_mean['time_series']=np.arange(0,len(Jul_BS_B_mean),1)
Jul_BS_B_mean=Jul_BS_B_mean.rename(columns={'0':'power'})
Jul_BS_B_mean['power']=Jul_BS_B_mean['power']
Jul_BS_B_mean['time_series']=Jul_BS_B_mean['time_series']/60

Aug_BS_B['time']=pd.date_range(start='8/1/2018', end='9/1/2018', freq='1min', closed='left')
Aug_BS_B['time'] = Aug_BS_B['time'].astype('str') 
Aug_BS_B[['local_date','local_time']] = Aug_BS_B.time.str.split(" ",expand=True,)
Aug_BS_B_mean=Aug_BS_B.groupby(Aug_BS_B.local_time).mean()
del Aug_BS_B_mean['Unnamed: 0']
Aug_BS_B_mean['time_series']=np.arange(0,len(Aug_BS_B_mean),1)
Aug_BS_B_mean=Aug_BS_B_mean.rename(columns={'0':'power'})
Aug_BS_B_mean['power']=Aug_BS_B_mean['power']
Aug_BS_B_mean['time_series']=Aug_BS_B_mean['time_series']/60

Sep_BS_B['time']=pd.date_range(start='9/1/2018', end='10/1/2018', freq='1min', closed='left')
Sep_BS_B['time'] = Sep_BS_B['time'].astype('str') 
Sep_BS_B[['local_date','local_time']] = Sep_BS_B.time.str.split(" ",expand=True,)
Sep_BS_B_mean=Sep_BS_B.groupby(Sep_BS_B.local_time).mean()
del Sep_BS_B_mean['Unnamed: 0']
Sep_BS_B_mean['time_series']=np.arange(0,len(Sep_BS_B_mean),1)
Sep_BS_B_mean=Sep_BS_B_mean.rename(columns={'0':'power'})
Sep_BS_B_mean['power']=Sep_BS_B_mean['power']
Sep_BS_B_mean['time_series']=Sep_BS_B_mean['time_series']/60

Oct_BS_B['time']=pd.date_range(start='10/1/2018', end='11/1/2018', freq='1min', closed='left')
Oct_BS_B['time'] = Oct_BS_B['time'].astype('str') 
Oct_BS_B[['local_date','local_time']] = Oct_BS_B.time.str.split(" ",expand=True,)
Oct_BS_B_mean=Oct_BS_B.groupby(Oct_BS_B.local_time).mean()
del Oct_BS_B_mean['Unnamed: 0']
Oct_BS_B_mean['time_series']=np.arange(0,len(Oct_BS_B_mean),1)
Oct_BS_B_mean=Oct_BS_B_mean.rename(columns={'0':'power'})
Oct_BS_B_mean['power']=Oct_BS_B_mean['power']
Oct_BS_B_mean['time_series']=Oct_BS_B_mean['time_series']/60

Nov_BS_B['time']=pd.date_range(start='11/1/2018', end='12/1/2018', freq='1min', closed='left')
Nov_BS_B['time'] = Nov_BS_B['time'].astype('str') 
Nov_BS_B[['local_date','local_time']] = Nov_BS_B.time.str.split(" ",expand=True,)
Nov_BS_B_mean=Nov_BS_B.groupby(Nov_BS_B.local_time).mean()
del Nov_BS_B_mean['Unnamed: 0']
Nov_BS_B_mean['time_series']=np.arange(0,len(Nov_BS_B_mean),1)
Nov_BS_B_mean=Nov_BS_B_mean.rename(columns={'0':'power'})
Nov_BS_B_mean['power']=Nov_BS_B_mean['power']
Nov_BS_B_mean['time_series']=Nov_BS_B_mean['time_series']/60

Dec_BS_B['time']=pd.date_range(start='12/1/2018', end='1/1/2019', freq='1min', closed='left')
Dec_BS_B['time'] = Dec_BS_B['time'].astype('str') 
Dec_BS_B[['local_date','local_time']] = Dec_BS_B.time.str.split(" ",expand=True,)
Dec_BS_B_mean=Dec_BS_B.groupby(Dec_BS_B.local_time).mean()
del Dec_BS_B_mean['Unnamed: 0']
Dec_BS_B_mean['time_series']=np.arange(0,len(Dec_BS_B_mean),1)
Dec_BS_B_mean=Dec_BS_B_mean.rename(columns={'0':'power'})
Dec_BS_B_mean['power']=Dec_BS_B_mean['power']
Dec_BS_B_mean['time_series']=Dec_BS_B_mean['time_series']/60
...
l2,=axs[0, 0].plot(Jan_BS_B_mean['time_series'], Jan_BS_B_mean['power'],color='blue',linewidth=1)
...
axs[0, 1].plot(Feb_BS_B_mean['time_series'], Feb_BS_B_mean['power'],color='blue',linewidth=1)
...
axs[0, 2].plot(Mar_BS_B_mean['time_series'], Jan_BS_B_mean['power'],color='blue',linewidth=1)
...
axs[0, 3].plot(Apr_BS_B_mean['time_series'], Apr_BS_B_mean['power'],color='blue',linewidth=1)
...
axs[1, 0].plot(May_BS_B_mean['time_series'], May_BS_B_mean['power'],color='blue',linewidth=1)
...
axs[1, 1].plot(Jun_BS_B_mean['time_series'], Jun_BS_B_mean['power'],color='blue',linewidth=1)
...
axs[1, 2].plot(Jul_BS_B_mean['time_series'], Jul_BS_B_mean['power'],color='blue',linewidth=1)
...
axs[1, 3].plot(Aug_BS_B_mean['time_series'], Aug_BS_B_mean['power'],color='blue',linewidth=1)
...
axs[2, 0].plot(Sep_BS_B_mean['time_series'], Sep_BS_B_mean['power'],color='blue',linewidth=1)
...
axs[2, 1].plot(Oct_BS_B_mean['time_series'], Oct_BS_B_mean['power'],color='blue',linewidth=1)
...
axs[2, 2].plot(Nov_BS_B_mean['time_series'], Nov_BS_B_mean['power'],color='blue',linewidth=1)
...
axs[2, 3].plot(Dec_BS_B_mean['time_series'], Dec_BS_B_mean['power'],color='blue',linewidth=1)
...
ax.legend(handles = [l1,l2] , labels=['occasional', 'average'],bbox_to_anchor=(1.7,3.5),fancybox=False,loc='upper right', shadow=False)
...
l0,=axs[0, 0].plot(Jan_sort['index_2'], Jan_sort['0'],color='blue',linewidth=1)
...
axs[0, 1].plot(Feb_sort['index_2'], Feb_sort['0'],color='blue',linewidth=1)
...
axs[0, 2].plot(Mar_sort['index_2'], Mar_sort['0'],color='blue',linewidth=1)
...
axs[1, 0].plot(Apr_sort['index_2'], Apr_sort['0'],color='blue',linewidth=1)
...
axs[1, 1].plot(May_sort['index_2'], May_sort['0'],color='blue',linewidth=1)
...
axs[1, 2].plot(Jun_sort['index_2'], Jun_sort['0'],color='blue',linewidth=1)
...
axs[2, 0].plot(Jul_sort['index_2'], Jul_sort['0'],color='blue',linewidth=1)
...
axs[2, 1].plot(Aug_sort['index_2'], Aug_sort['0'],color='blue',linewidth=1)
...
axs[2, 2].plot(Sep_sort['index_2'], Sep_sort['0'],color='blue',linewidth=1)
...
axs[3, 0].plot(Oct_sort['index_2'], Oct_sort['0'],color='blue',linewidth=1)
...
axs[3, 1].plot(Nov_sort['index_2'], Nov_sort['0'],color='blue',linewidth=1)
...
axs[3, 2].plot(Dec_sort['index_2'], Dec_sort['0'],color='blue',linewidth=1)
...
#plt.savefig('profiles_temp_raq_2018.png', dpi=200,bbox_inches="tight")
ax.legend(handles = [l0,l1,l2] , labels=['atypical', 'average'],bbox_to_anchor=(1.5,5.5),fancybox=False,loc='upper right', shadow=False)
