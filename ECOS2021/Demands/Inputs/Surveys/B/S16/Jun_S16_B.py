...
#whasing macLIne
LI_Whasing_macline = LI.Appliance(LI,1,500,1,10,0.1,10, occasional_use = 0.0085)
LI_Whasing_macline.windows([600,780],[0,0])

#Water pump
LI_Water_pump = LI.Appliance(LI,1,250,2,37.5,0.47,15)
LI_Water_pump.windows([420,450],[960,1020],0.1)

LI_DVD = LI.Appliance(LI,1,8,3,37,0.3,20)                                                                  
LI_DVD.windows([1200,1440],[840,1080],0.3,[300,550])

#blender
LI_Blender = LI.Appliance(LI,1,350,2,10,0.375,7.5)
LI_Blender.windows([900,1020],[420,600],0.5)

LI_Iron = LI.Appliance(LI,1,1000,2,22.5,0.5,10,occasional_use =0.01)
LI_Iron.windows([420,480],[720,780],0.5)

#mill
LI_Mill = LI.Appliance(LI,1,3000,2,90,0.48,35, occasional_use = 0.02)
