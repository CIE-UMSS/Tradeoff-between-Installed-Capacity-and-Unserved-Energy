...
#radio
LI_Radio = LI.Appliance(LI,1,7,2,185,0.3,49)
LI_Radio.windows([480,840],[841,1200],0.5)

#radio
LI_Radio = LI.Appliance(LI,1,7,2,210,0.3,49)
LI_Radio.windows([480,840],[841,1200],0.5)

#radio
LI_Radio = LI.Appliance(LI,1,7,2,235,0.3,49)
LI_Radio.windows([480,840],[841,1200],0.5)

#radio
LI_Radio = LI.Appliance(LI,1,7,2,285,0.3,49)
LI_Radio.windows([480,840],[841,1200],0.5)

#radio
LI_Radio = LI.Appliance(LI,1,7,2,310,0.3,49)
LI_Radio.windows([480,840],[841,1200],0.5)
